...
namespace PeopleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bob.FavoriteAncientWonder = WondersOfTheAcientWorld.StatusOfZeusAtOlympia;
            //bob.BucketList = WondersOfTheAcientWorld.HangingGardensOfBabylon | WondersOfTheAcientWorld.MausoleumAtHalicarnassus;
            bob.BucketList = (WondersOfTheAcientWorld)18;
            bob.Children.Add(new Person { Name = "Alfred" });
            bob.Children.Add(new Person { Name = "Zoe" });

            WriteLine(
                format: "{0} was born on {1:dddd, d MMMMM yyyy}",
                arg0: bob.Name,
            ...
            // This will throw an error due to init only
            ...
            var repaintedCare = car with { Color = "Polymetal Grey Metallic" };

            WriteLine("Original color was {0}, new color is {1}.",
                arg0: car.Color,
                arg1: repaintedCare.Color
            );
